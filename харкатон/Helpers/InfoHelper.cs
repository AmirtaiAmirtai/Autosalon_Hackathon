...
namespace харкатон.Helpers
{
    ...
    {
        new Car { Id = 1, Name = "SleekSport ZR5000", Price = 20000m, Description = "The SleekSport ZR5000 is a high-performance sports car designed for " +
        ...
        new Car { Id = 2, Name = "Urban Voyager XL", Price = 30000m, Description = "The Urban Voyager XL is a versatile and spacious SUV" +
        ...
        new Car { Id = 3, Name = "EcoDrive E1", Price = 40000m, Description = "The EcoDrive E1 is an eco-friendly compact car that" +
        ...
        new Car { Id = 4, Name = "Luxury Cruiser 9000", Price = 80000m, Description = "The Luxury Cruiser 9000 defines opulence on wheels." +
        ...
        new Car { Id = 5, Name = "Adventure Trailblazer X", Price = 42000m, Description = "The Adventure Trailblazer X is the perfect" +
        ...
        new Car { Id = 6, Name = "Cityscape Commuter S", Price = 28000m, Description = "The Cityscape Commuter S is a compact yet stylish" +
            ...
            " for comfort and convenience. With advancedsafety features, smart connectivity, and impressive fuel economy, this car" + 
            " is the ideal choice for daily commuters navigating busy city life." },



        new Car { Id = 7, Name = "TechEnthusiast EVX", Price = 55000m, Description = "The TechEnthusiast EVX is a cutting-edge electric" +
        ...
        new Car { Id = 8, Name = "Classic Revival 67", Price = 65000m, Description = "The Classic Revival 67 pays homage to the golden era" +
